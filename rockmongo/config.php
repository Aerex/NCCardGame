...
$MONGO["servers"][$i]["control_users"]["admin"] = "admin96sh72635+";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false

$MONGO["servers"][$i]["mongo_user"] = "root";
$MONGO["servers"][$i]["mongo_pass"] = "96sh72635+";
